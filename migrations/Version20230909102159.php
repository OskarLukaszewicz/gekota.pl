 ...
 */
final class Version20230909102159 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__dashboard_config AS SELECT id, animals_num, blog_posts_num, events_weeks_num FROM dashboard_config');
        ...
        $this->addSql('INSERT INTO dashboard_config (id, animals_num, blog_posts_num, events_weeks_num) SELECT id, animals_num, blog_posts_num, events_weeks_num FROM __temp__dashboard_config');
